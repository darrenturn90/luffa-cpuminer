...
} luffahash_context_holder;

luffahash_context_holder base_contexts;

void init_luffahash_contexts()
{
   // sph_blake512_init(&base_contexts.blake1);
  sph_luffa512_init(&base_contexts.luffa1);
}

static void luffahash(void *state, const void *input)
{
	luffahash_context_holder ctx;
